...
- API version: 1001.0.0-SNAPSHOT-0daa9a9e2722e510da52cb72ee41a43128c97f42
...
*ProjectTemplatesApi* | [**live_template**](docs/ProjectTemplatesApi.md#live_template) | **GET** /rest/api/3/project-template/live-template | Gets a custom project template
...
*ServiceRegistryApi* | [**service_registry_resource_services_get**](docs/ServiceRegistryApi.md#service_registry_resource_services_get) | **GET** /rest/atlassian-connect/1/service-registry | Retrieve the attributes of service registries
...
*StatusApi* | [**get_project_issue_type_usages_for_status**](docs/StatusApi.md#get_project_issue_type_usages_for_status) | **GET** /rest/api/3/statuses/{statusId}/project/{projectId}/issueTypeUsages | Get issue type usages by status and project
...
*WorkflowSchemesApi* | [**get_project_usages_for_workflow_scheme**](docs/WorkflowSchemesApi.md#get_project_usages_for_workflow_scheme) | **GET** /rest/api/3/workflowscheme/{workflowSchemeId}/projectUsages | Get projects which are using a given workflow scheme
...
*WorkflowSchemesApi* | [**read_workflow_schemes**](docs/WorkflowSchemesApi.md#read_workflow_schemes) | **POST** /rest/api/3/workflowscheme/read | Bulk get workflow schemes
...
*WorkflowSchemesApi* | [**update_schemes**](docs/WorkflowSchemesApi.md#update_schemes) | **POST** /rest/api/3/workflowscheme/update | Update workflow scheme
...
*WorkflowSchemesApi* | [**update_workflow_scheme**](docs/WorkflowSchemesApi.md#update_workflow_scheme) | **PUT** /rest/api/3/workflowscheme/{id} | Classic update workflow scheme
*WorkflowSchemesApi* | [**update_workflow_scheme_mappings**](docs/WorkflowSchemesApi.md#update_workflow_scheme_mappings) | **POST** /rest/api/3/workflowscheme/update/mappings | Get required status mappings for workflow scheme update
...
*WorkflowsApi* | [**create_workflows**](docs/WorkflowsApi.md#create_workflows) | **POST** /rest/api/3/workflows/create | Bulk create workflows
...
*WorkflowsApi* | [**get_default_editor**](docs/WorkflowsApi.md#get_default_editor) | **GET** /rest/api/3/workflows/defaultEditor | Get the user&#x27;s default workflow editor
*WorkflowsApi* | [**get_project_usages_for_workflow**](docs/WorkflowsApi.md#get_project_usages_for_workflow) | **GET** /rest/api/3/workflow/{workflowId}/projectUsages | Get projects using a given workflow
*WorkflowsApi* | [**get_workflow_project_issue_type_usages**](docs/WorkflowsApi.md#get_workflow_project_issue_type_usages) | **GET** /rest/api/3/workflow/{workflowId}/project/{projectId}/issueTypeUsages | Get issue types in a project that are using a given workflow
*WorkflowsApi* | [**get_workflow_scheme_usages_for_workflow**](docs/WorkflowsApi.md#get_workflow_scheme_usages_for_workflow) | **GET** /rest/api/3/workflow/{workflowId}/workflowSchemes | Get workflow schemes which are using a given workflow
...
*WorkflowsApi* | [**read_workflows**](docs/WorkflowsApi.md#read_workflows) | **POST** /rest/api/3/workflows | Bulk get workflows
*WorkflowsApi* | [**search_workflows**](docs/WorkflowsApi.md#search_workflows) | **GET** /rest/api/3/workflows/search | Search workflows
*WorkflowsApi* | [**update_workflows**](docs/WorkflowsApi.md#update_workflows) | **POST** /rest/api/3/workflows/update | Bulk update workflows
*WorkflowsApi* | [**validate_create_workflows**](docs/WorkflowsApi.md#validate_create_workflows) | **POST** /rest/api/3/workflows/create/validation | Validate create workflows
*WorkflowsApi* | [**validate_update_workflows**](docs/WorkflowsApi.md#validate_update_workflows) | **POST** /rest/api/3/workflows/update/validation | Validate update workflows
*WorkflowsApi* | [**workflow_capabilities**](docs/WorkflowsApi.md#workflow_capabilities) | **GET** /rest/api/3/workflows/capabilities | Get available workflow capabilities
*UsernavpropertiesApi* | [**get_user_nav_property**](docs/UsernavpropertiesApi.md#get_user_nav_property) | **GET** /rest/api/3/user/nav4-opt-property/{propertyKey} | Get user nav property
*UsernavpropertiesApi* | [**set_user_nav_property**](docs/UsernavpropertiesApi.md#set_user_nav_property) | **PUT** /rest/api/3/user/nav4-opt-property/{propertyKey} | Set user nav property
...
## Documentation For Models
 ...
 - [AllOfCreatePermissionRequestHolder](docs/AllOfCreatePermissionRequestHolder.md)
 - [AllOfCreatePlanRequestExclusionRules](docs/AllOfCreatePlanRequestExclusionRules.md)
 - [AllOfCreatePlanRequestScheduling](docs/AllOfCreatePlanRequestScheduling.md)
 - [AllOfCreatePrioritySchemeDetailsMappings](docs/AllOfCreatePrioritySchemeDetailsMappings.md)
 - [AllOfCreateSchedulingRequestEndDate](docs/AllOfCreateSchedulingRequestEndDate.md)
 - [AllOfCreateSchedulingRequestStartDate](docs/AllOfCreateSchedulingRequestStartDate.md)
 ...
 - [AllOfGetPermissionResponseHolder](docs/AllOfGetPermissionResponseHolder.md)
 - [AllOfGetPlanResponseExclusionRules](docs/AllOfGetPlanResponseExclusionRules.md)
 - [AllOfGetPlanResponseScheduling](docs/AllOfGetPlanResponseScheduling.md)
 - [AllOfGetSchedulingResponseEndDate](docs/AllOfGetSchedulingResponseEndDate.md)
 - [AllOfGetSchedulingResponseStartDate](docs/AllOfGetSchedulingResponseStartDate.md)
 ...
 - [AllOfIssueBulkEditPayloadEditedFieldsInput](docs/AllOfIssueBulkEditPayloadEditedFieldsInput.md)
 ...
 - [AllOfJExpEvaluateJiraExpressionResultBeanMeta](docs/AllOfJExpEvaluateJiraExpressionResultBeanMeta.md)
 - [AllOfJExpEvaluateMetaDataBeanComplexity](docs/AllOfJExpEvaluateMetaDataBeanComplexity.md)
 - [AllOfJExpEvaluateMetaDataBeanIssues](docs/AllOfJExpEvaluateMetaDataBeanIssues.md)
 - [AllOfJexpEvaluateCtxIssuesJql](docs/AllOfJexpEvaluateCtxIssuesJql.md)
 ...
 - [AllOfJiraExpressionEvaluateContextBeanIssue](docs/AllOfJiraExpressionEvaluateContextBeanIssue.md)
 - [AllOfJiraExpressionEvaluateContextBeanIssues](docs/AllOfJiraExpressionEvaluateContextBeanIssues.md)
 - [AllOfJiraExpressionEvaluateContextBeanProject](docs/AllOfJiraExpressionEvaluateContextBeanProject.md)
 - [AllOfJiraExpressionEvaluateRequestBeanContext](docs/AllOfJiraExpressionEvaluateRequestBeanContext.md)
 ...
 - [AllOfJiraIssueFieldsIssueType](docs/AllOfJiraIssueFieldsIssueType.md)
 - [AllOfJiraIssueFieldsMultiselectComponents](docs/AllOfJiraIssueFieldsMultiselectComponents.md)
 - [AllOfJiraIssueFieldsOriginalEstimateField](docs/AllOfJiraIssueFieldsOriginalEstimateField.md)
 - [AllOfJiraIssueFieldsPriority](docs/AllOfJiraIssueFieldsPriority.md)
 - [AllOfJiraIssueFieldsTimeTrackingField](docs/AllOfJiraIssueFieldsTimeTrackingField.md)
 ...
 - [AllOfPrioritySchemeIdTask](docs/AllOfPrioritySchemeIdTask.md)
 ...
 - [AllOfSimplifiedIssueTransitionTo](docs/AllOfSimplifiedIssueTransitionTo.md)
 - [AllOfSuggestedMappingsRequestBeanPriorities](docs/AllOfSuggestedMappingsRequestBeanPriorities.md)
 - [AllOfSuggestedMappingsRequestBeanProjects](docs/AllOfSuggestedMappingsRequestBeanProjects.md)
 - [AllOfTaskProgressBeanJsonNodeResult](docs/AllOfTaskProgressBeanJsonNodeResult.md)
 - [AllOfTaskProgressBeanRemoveOptionFromIssuesResultResult](docs/AllOfTaskProgressBeanRemoveOptionFromIssuesResultResult.md)
 - [AllOfUpdatePrioritySchemeRequestBeanMappings](docs/AllOfUpdatePrioritySchemeRequestBeanMappings.md)
 - [AllOfUpdatePrioritySchemeRequestBeanPriorities](docs/AllOfUpdatePrioritySchemeRequestBeanPriorities.md)
 - [AllOfUpdatePrioritySchemeRequestBeanProjects](docs/AllOfUpdatePrioritySchemeRequestBeanProjects.md)
 ...
 - [AnyOffields](docs/AnyOffields.md)
 ...
 - [IssueBulkOperationsFieldOption](docs/IssueBulkOperationsFieldOption.md)
 ...
 - [UserNavPropertyJsonBean](docs/UserNavPropertyJsonBean.md)
