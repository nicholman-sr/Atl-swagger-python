...
class CustomFieldReplacement(object):
    ...
    def __init__(self, custom_field_id=None, move_to=None):  # noqa: E501
        """CustomFieldReplacement - a model defined in Swagger"""  # noqa: E501
    ...
    def custom_field_id(self):
        """Gets the custom_field_id of this CustomFieldReplacement.  # noqa: E501

        The ID of the custom field in which to replace the version number.  # noqa: E501

        :return: The custom_field_id of this CustomFieldReplacement.  # noqa: E501
        :rtype: int
        """
    ...
    @property
    def move_to(self):
        """Gets the move_to of this CustomFieldReplacement.  # noqa: E501

        The version number to use as a replacement for the deleted version.  # noqa: E501

        :return: The move_to of this CustomFieldReplacement.  # noqa: E501
        :rtype: int
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CustomFieldReplacement, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CustomFieldReplacement):
            return False
