...
[**get_default_editor**](WorkflowsApi.md#get_default_editor) | **GET** /rest/api/3/workflows/defaultEditor | Get the user&#x27;s default workflow editor
[**get_project_usages_for_workflow**](WorkflowsApi.md#get_project_usages_for_workflow) | **GET** /rest/api/3/workflow/{workflowId}/projectUsages | Get projects using a given workflow
...
# **create_workflow**
> WorkflowIDs create_workflow(body)
...
api_instance = jira_client.WorkflowsApi(jira_client.ApiClient(configuration))
body = jira_client.CreateWorkflowDetails() # CreateWorkflowDetails | The workflow details.
...
# **create_workflows**
> WorkflowCreateResponse create_workflows(body)
...
# create an instance of the API class
api_instance = jira_client.WorkflowsApi(jira_client.ApiClient(configuration))
body = jira_client.WorkflowCreateRequest() # WorkflowCreateRequest | 

try:
    # Bulk create workflows
    api_response = api_instance.create_workflows(body)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling WorkflowsApi->create_workflows: %s\n" % e)
```
...
# **get_default_editor**
> DefaultWorkflowEditorResponse get_default_editor()
...
try:
    # Get the user's default workflow editor
    api_response = api_instance.get_default_editor()
    pprint(api_response)
except ApiException as e:
    print("Exception when calling WorkflowsApi->get_default_editor: %s\n" % e)
```
...
> WorkflowProjectUsageDTO get_project_usages_for_workflow(workflow_id, next_page_token=next_page_token, max_results=max_results)
...
# create an instance of the API class
api_instance = jira_client.WorkflowsApi(jira_client.ApiClient(configuration))
workflow_id = 'workflow_id_example' # str | The workflow ID
...
try:
    # Get projects using a given workflow
    api_response = api_instance.get_project_usages_for_workflow(workflow_id, next_page_token=next_page_token, max_results=max_results)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling WorkflowsApi->get_project_usages_for_workflow: %s\n" % e)
```
...
> WorkflowProjectIssueTypeUsageDTO get_workflow_project_issue_type_usages(workflow_id, project_id, next_page_token=next_page_token, max_results=max_results)
...
try:
    # Get issue types in a project that are using a given workflow
    api_response = api_instance.get_workflow_project_issue_type_usages(workflow_id, project_id, next_page_token=next_page_token, max_results=max_results)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling WorkflowsApi->get_workflow_project_issue_type_usages: %s\n" % e)
```
...
> WorkflowSchemeUsageDTO get_workflow_scheme_usages_for_workflow(workflow_id, next_page_token=next_page_token, max_results=max_results)
...
try:
    # Get workflow schemes which are using a given workflow
    api_response = api_instance.get_workflow_scheme_usages_for_workflow(workflow_id, next_page_token=next_page_token, max_results=max_results)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling WorkflowsApi->get_workflow_scheme_usages_for_workflow: %s\n" % e)
```
...
# **read_workflows**
> WorkflowReadResponse read_workflows(body, use_approval_configuration=use_approval_configuration)
...
# create an instance of the API class
api_instance = jira_client.WorkflowsApi(jira_client.ApiClient(configuration))
body = jira_client.WorkflowReadRequest() # WorkflowReadRequest | 
use_approval_configuration = false # bool | Return the new field `approvalConfiguration` instead of the deprecated status properties for approval configuration. (optional) (default to false)

try:
    # Bulk get workflows
    api_response = api_instance.read_workflows(body, use_approval_configuration=use_approval_configuration)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling WorkflowsApi->read_workflows: %s\n" % e)
```
 ...
 **use_approval_configuration** | **bool**| Return the new field &#x60;approvalConfiguration&#x60; instead of the deprecated status properties for approval configuration. | [optional] [default to false]
...
# **search_workflows**
> WorkflowSearchResponse search_workflows(start_at=start_at, max_results=max_results, expand=expand, query_string=query_string, order_by=order_by, scope=scope, is_active=is_active)
...
# create an instance of the API class
api_instance = jira_client.WorkflowsApi(jira_client.ApiClient(configuration))
start_at = 789 # int | The index of the first item to return in a page of results (page offset). (optional)
max_results = 56 # int | The maximum number of items to return per page. (optional)
expand = 'expand_example' # str | Use [expand](#expansion) to include additional information in the response. This parameter accepts a comma-separated list. Expand options include:   *  `values.transitions` Returns the transitions that each workflow is associated with. (optional)
query_string = 'query_string_example' # str | String used to perform a case-insensitive partial match with workflow name. (optional)
order_by = 'order_by_example' # str | [Order](#ordering) the results by a field:   *  `name` Sorts by workflow name.  *  `created` Sorts by create time.  *  `updated` Sorts by update time. (optional)
scope = 'scope_example' # str | The scope of the workflow. Global for company-managed projects and Project for team-managed projects. (optional)
is_active = true # bool | Filters active and inactive workflows. (optional)

try:
    # Search workflows
    api_response = api_instance.search_workflows(start_at=start_at, max_results=max_results, expand=expand, query_string=query_string, order_by=order_by, scope=scope, is_active=is_active)
    pprint(api_response)
except ApiException as e:
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **start_at** | **int**| The index of the first item to return in a page of results (page offset). | [optional] 
 **max_results** | **int**| The maximum number of items to return per page. | [optional] 
 **expand** | **str**| Use [expand](#expansion) to include additional information in the response. This parameter accepts a comma-separated list. Expand options include:   *  &#x60;values.transitions&#x60; Returns the transitions that each workflow is associated with. | [optional] 
 **query_string** | **str**| String used to perform a case-insensitive partial match with workflow name. | [optional] 
 **order_by** | **str**| [Order](#ordering) the results by a field:   *  &#x60;name&#x60; Sorts by workflow name.  *  &#x60;created&#x60; Sorts by create time.  *  &#x60;updated&#x60; Sorts by update time. | [optional] 
 **scope** | **str**| The scope of the workflow. Global for company-managed projects and Project for team-managed projects. | [optional] 
 **is_active** | **bool**| Filters active and inactive workflows. | [optional] 
...
# **update_workflows**
> WorkflowUpdateResponse update_workflows(body)
...
# create an instance of the API class
api_instance = jira_client.WorkflowsApi(jira_client.ApiClient(configuration))
body = jira_client.WorkflowUpdateRequest() # WorkflowUpdateRequest | 

try:
    # Bulk update workflows
    api_response = api_instance.update_workflows(body)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling WorkflowsApi->update_workflows: %s\n" % e)
```
...
> WorkflowValidationErrorList validate_create_workflows(body)
...
# create an instance of the API class
api_instance = jira_client.WorkflowsApi(jira_client.ApiClient(configuration))
body = jira_client.WorkflowCreateValidateRequest() # WorkflowCreateValidateRequest | 

try:
    # Validate create workflows
    api_response = api_instance.validate_create_workflows(body)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling WorkflowsApi->validate_create_workflows: %s\n" % e)
```
...
> WorkflowValidationErrorList validate_update_workflows(body)
...
# create an instance of the API class
api_instance = jira_client.WorkflowsApi(jira_client.ApiClient(configuration))
body = jira_client.WorkflowUpdateValidateRequestBean() # WorkflowUpdateValidateRequestBean | 

try:
    # Validate update workflows
    api_response = api_instance.validate_update_workflows(body)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling WorkflowsApi->validate_update_workflows: %s\n" % e)
```
...
> WorkflowCapabilities workflow_capabilities(workflow_id=workflow_id, project_id=project_id, issue_type_id=issue_type_id)
...
issue_type_id = 'issue_type_id_example' # str |  (optional)

try:
    # Get available workflow capabilities
    api_response = api_instance.workflow_capabilities(workflow_id=workflow_id, project_id=project_id, issue_type_id=issue_type_id)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling WorkflowsApi->workflow_capabilities: %s\n" % e)
```
