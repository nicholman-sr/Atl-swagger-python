...
class IssueTypeScreenSchemeUpdateDetails(object):
    ...
    def __init__(self, description=None, name=None):  # noqa: E501
        """IssueTypeScreenSchemeUpdateDetails - a model defined in Swagger"""  # noqa: E501
    ...
    def description(self):
        """Gets the description of this IssueTypeScreenSchemeUpdateDetails.  # noqa: E501

        The description of the issue type screen scheme. The maximum length is 255 characters.  # noqa: E501

        :return: The description of this IssueTypeScreenSchemeUpdateDetails.  # noqa: E501
        :rtype: str
        """
    ...
    @property
    def name(self):
        """Gets the name of this IssueTypeScreenSchemeUpdateDetails.  # noqa: E501

        The name of the issue type screen scheme. The name must be unique. The maximum length is 255 characters.  # noqa: E501

        :return: The name of this IssueTypeScreenSchemeUpdateDetails.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(IssueTypeScreenSchemeUpdateDetails, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, IssueTypeScreenSchemeUpdateDetails):
            return False
