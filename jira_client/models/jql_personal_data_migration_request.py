...
class JQLPersonalDataMigrationRequest(object):
    ...
    def __init__(self, query_strings=None):  # noqa: E501
        """JQLPersonalDataMigrationRequest - a model defined in Swagger"""  # noqa: E501
    ...
    def query_strings(self):
        """Gets the query_strings of this JQLPersonalDataMigrationRequest.  # noqa: E501

        A list of queries with user identifiers. Maximum of 100 queries.  # noqa: E501

        :return: The query_strings of this JQLPersonalDataMigrationRequest.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(JQLPersonalDataMigrationRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, JQLPersonalDataMigrationRequest):
            return False
