...
class KeywordOperand(object):
    ...
    def __init__(self, keyword=None):  # noqa: E501
        """KeywordOperand - a model defined in Swagger"""  # noqa: E501
        self._keyword = None
    ...
    @property
    def keyword(self):
        """Gets the keyword of this KeywordOperand.  # noqa: E501

        The keyword that is the operand value.  # noqa: E501

        :return: The keyword of this KeywordOperand.  # noqa: E501
        :rtype: str
        """
    ...
    def keyword(self, keyword):
        ...
        if keyword not in allowed_values:
            raise ValueError(
                "Invalid value for `keyword` ({0}), must be one of {1}"  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(KeywordOperand, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, KeywordOperand):
            return False
