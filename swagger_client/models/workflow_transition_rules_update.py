...
class WorkflowTransitionRulesUpdate(object):
    ...
    def __init__(self, workflows=None):  # noqa: E501
        """WorkflowTransitionRulesUpdate - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def workflows(self):
        """Gets the workflows of this WorkflowTransitionRulesUpdate.  # noqa: E501

        The list of workflows with transition rules to update.  # noqa: E501

        :return: The workflows of this WorkflowTransitionRulesUpdate.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(WorkflowTransitionRulesUpdate, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, WorkflowTransitionRulesUpdate):
            return False
